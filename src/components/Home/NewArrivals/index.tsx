    ...
    <section className="overflow-hidden pt-10 sm:pt-15 lg:pt-17.5">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        ...
        <div className="mb-5 sm:mb-7 flex items-center justify-between">
          ...
          <Link
            href={ROUTES.shop}
            className="inline-flex font-medium text-2xs sm:text-custom-sm py-2 sm:py-2.5 px-4 sm:px-7 rounded-md border-gray-3 dark:border-darkTheme-border-color border bg-gray-1 dark:bg-darkTheme-secondary-bg text-dark dark:text-darkTheme-body-color ease-out duration-200 hover:bg-dark hover:text-white hover:border-transparent dark:hover:bg-darkTheme-tertiary-bg"
          >
            View All
          </Link>
        </div>

        <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-6 lg:gap-7.5">
          {/* <!-- New on Xerin item --> */}
