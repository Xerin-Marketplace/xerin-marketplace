        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-10 xl:gap-8 pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="sm:col-span-2 xl:col-span-1 max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li>
                <a href={ROUTES.contact} className="flex items-center gap-4.5">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
          ...
          <div className="flex gap-5 flex-wrap items-center justify-between">
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="flex flex-wrap items-center gap-6">
                ...
                <a href={PAYMENT_LINKS.paypal} aria-label="payment system with paypal">
                  <Image
                ...
                <a href={PAYMENT_LINKS.applePay} aria-label="payment system with apple pay">
                  <Image
                ...
                <a href={PAYMENT_LINKS.googlePay} aria-label="payment system with google pay">
                  <Image
