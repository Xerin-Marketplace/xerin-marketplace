  ...
  return (
    <div className="mt-9">
      ...
      <div className="bg-white dark:bg-darkTheme-card shadow-1 rounded-[10px] p-4 sm:p-8.5">
        ...
        <div className="mb-5">
          <label htmlFor="town" className="block mb-2.5 dark:text-darkTheme-body-color">
        ...
        <div>
          <label
            ...
            className="text-dark dark:text-darkTheme-body-color flex cursor-pointer select-none items-center"
          >
            <div className="relative">
              <input
                type="checkbox"
                ...
                className="sr-only"
              />
              <div className="mr-2 flex h-4 w-4 items-center justify-center rounded border border-gray-4 dark:border-darkTheme-border-color">
