                ...
                <div className="bg-white dark:bg-darkTheme-card shadow-1 rounded-[10px]">
                  ...
                  <div className="pt-2.5 pb-8.5 px-4 sm:px-8.5">
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3 dark:border-darkTheme-border-color">
                      ...
                      <div>
                        <h4 className="font-medium text-dark dark:text-darkTheme-body-color text-right">
                          Subtotal
                        </h4>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3 dark:border-darkTheme-border-color">
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color">Smartphone 6GB/128GB</p>
                      </div>
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color text-right">$899.00</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3 dark:border-darkTheme-border-color">
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color">Dual Band WiFi Router</p>
                      </div>
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color text-right">$129.00</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3 dark:border-darkTheme-border-color">
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color">Wireless Headphones</p>
                      </div>
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color text-right">$29.00</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-between py-5 border-b border-gray-3 dark:border-darkTheme-border-color">
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color">Shipping Fee</p>
                      </div>
                      <div>
                        <p className="text-dark dark:text-darkTheme-body-color text-right">$15.00</p>
                      </div>
                    </div>
