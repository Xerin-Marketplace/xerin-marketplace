            ...
            <div className="lg:max-w-[750px] w-full">
              ...
              <div>
                <span className="flex items-center gap-3 mb-4">
                  <a href={ROUTES.blogDetailsWithSidebar} className="ease-out duration-200 hover:text-blue">
                    Mar 27, 2022
                  </a>
                ...
                <p className="mb-6">
                  Delivery information also supports customer care. When the address,
                  contact details, and order notes are accurate, Xerin Market can
                  help buyers, sellers, and logistics teams resolve delivery issues
                  faster.
                </p>
                ...
                <div className="mt-7.5">
                  ...
                  <ul className="list-disc pl-6">
                    <li>Confirm the buyer name, phone number, and delivery address.</li>
                    <li>Review product quantity, packaging details, and delivery option.</li>
                    <li>
                      Keep order status updated so buyers can track progress.
                    </li>
                    <li>Use Xerin Logistics tracking when available.</li>
                  </ul>
                </div>
                ...
                <p className="mb-6">
                  Accurate delivery details also help reduce failed deliveries, refund
                  requests, and order disputes. Buyers and sellers should confirm
                  the information before checkout or dispatch.
                </p>

                <p>
                  For smooth delivery on Xerin Market, buyers should provide a clear
                  delivery address, reachable phone number, and any location
                  notes that help the courier find the destination.
                </p>
