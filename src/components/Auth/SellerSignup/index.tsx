...
const FEATURES = [
  { icon: <ShieldIcon />, title: "Marketplace Checkout", description: "Use payment methods made available for each order" },
  { icon: <TruckIcon />, title: "Delivery Options", description: "Use shipping options returned by the marketplace" },
...
const SellerPanel = ({ onSwitchTab }: { onSwitchTab: (tab: AuthTab) => void }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
        ...
        <div className="rounded-lg border border-gray-3 dark:border-darkTheme-border-color max-h-44 overflow-y-auto p-3 bg-gray-1 dark:bg-darkTheme-secondary-bg">
          ...
          {!categoriesLoading && categoriesError && (
            <div className="flex items-center justify-between py-2">
              <p className="text-sm text-red">Couldn&apos;t load categories check you internet connection.</p>
      ...
      <div className="mb-4 bg-red-600 text-white text-center p-4 text-xl font-bold">
  SELLER COMPONENT UPDATED - TEST
</div>
