...
const ProductItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] dark:bg-darkTheme-secondary-bg min-h-[270px] mb-4">
        <Image src={item.imgs.previews[0]} alt={item.title} width={250} height={250} className="object-contain" />
      ...
      <h3
        className="font-medium text-dark dark:text-white ease-out duration-200 hover:text-blue mb-1.5"
