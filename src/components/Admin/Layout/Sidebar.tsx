...
const sidebarGroups: SidebarGroup[] = [
  ...
  },
  {
    ...
    icon: CreditCard,
    items: [
      { label: "Transactions", href: "/admin/finance", icon: CreditCard },
      { label: "Payment Methods", href: "/admin/finance?tab=methods", icon: WalletCards },
      { label: "Refunds", href: "/admin/finance?tab=refunds", icon: Scale },
      { label: "Failed Payments", href: "/admin/finance?tab=failed", icon: X },
    ],
  },
  {
    title: "Promotions",
