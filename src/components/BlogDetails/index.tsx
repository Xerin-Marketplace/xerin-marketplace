        ...
        <div className="max-w-[750px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div>
            <span className="flex items-center gap-3 mb-4">
              <a href={ROUTES.blogDetails} className="ease-out duration-200 hover:text-blue">
                Mar 27, 2022
              </a>
            ...
            <p>
              ...
              delivery address, reachable phone number, and any location notes
              that help the courier find the destination.
            </p>
