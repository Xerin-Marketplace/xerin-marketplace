                ...
                <div className="min-w-[1170px]">
                  ...
                  <div className="flex items-center py-5.5 px-7.5">
                    ...
                    <div className="min-w-[180px]">
                      <p className="text-dark dark:text-darkTheme-body-color">Price</p>
                    </div>

                    <div className="min-w-[275px]">
                      <p className="text-dark dark:text-darkTheme-body-color">Quantity</p>
                    </div>

                    <div className="min-w-[200px]">
                      <p className="text-dark dark:text-darkTheme-body-color">Subtotal</p>
                    </div>
