...
const Header = () => {
  ...
  return (
    <header
      className={`fixed left-0 top-0 w-full z-9999 bg-white dark:bg-darkTheme-bg transition-all ease-in-out duration-300 ${
        stickyMenu && "shadow"
      }`}
    >
              ...
              <div className="flex items-center gap-5">
                ...
                >
                  {theme === "dark" ? (
                    ...
                    >
                      <path
                        d="M21 12.79A9 9 0 1111.21 3C7.33 3 4.1 5.98 4.1 10C4.1 14.02 7.33 17 11.21 17C15.09 17 18.31 14.02 18.31 10C18.31 9.68 18.28 9.37 18.21 9.07L21 12.79Z"
                        fill="currentColor"
                      />
                    </svg>
                  )}
              ...
              >
                <span className="block relative cursor-pointer w-5.5 h-5.5">
                  <span className="du-block absolute right-0 w-full h-full">
                    <span
                      className={`block relative top-0 left-0 bg-dark dark:bg-darkTheme-body-color rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-[0] ${
                        !navigationOpen && "!w-full delay-300"
                      }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-dark dark:bg-darkTheme-body-color rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-150 ${
                        !navigationOpen && "!w-full delay-400"
                      }`}
                    ></span>
                    <span
                      className={`block relative top-0 left-0 bg-dark dark:bg-darkTheme-body-color rounded-sm w-0 h-0.5 my-1 ease-in-out duration-200 delay-200 ${
                  ...
                  <span className="block absolute right-0 w-full h-full rotate-45">
                    <span
                      className={`block bg-dark dark:bg-darkTheme-body-color rounded-sm ease-in-out duration-200 delay-300 absolute left-2.5 top-0 w-0.5 h-full ${
                        !navigationOpen && "!h-0 delay-[0] "
                      }`}
                    ></span>
                    <span
                      className={`block bg-dark dark:bg-darkTheme-body-color rounded-sm ease-in-out duration-200 delay-400 absolute left-0 top-2.5 w-full h-0.5 ${
